...
import sqlalchemy
import logging
from bertopic_model import CategoryBERTopicModeler, apply_category_models
...
async def modeling():
    try:
        ...
        # Define a tokenizer function for the CountVectorizer
        def tokenizer(text):
            return text.split()

        # Apply category-based topic modeling
